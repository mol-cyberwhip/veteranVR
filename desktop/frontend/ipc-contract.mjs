...
export function assertOperationSnapshot(snapshot) {
...
export function assertEventEnvelope(payload) {
  if (!isObject(payload)) {
...
export function assertDeviceStateSnapshot(payload) {
  if (!isObject(payload)) {
...
export function summarizeOperationSnapshot(snapshot, fallbackOperationId = null) {
...
const CATALOG_SOURCES = new Set(["none", "network", "cache", "mock"]);

export function assertCatalogStatusSnapshot(payload) {
  if (!isObject(payload)) {
  ...
  if (typeof payload.source !== "string" || !CATALOG_SOURCES.has(payload.source)) {
    throw new Error("catalog.source must be one of none/network/cache/mock.");
  }
...
export function assertCatalogSearchResult(payload) {
  if (!isObject(payload)) {
...
export function assertLibraryResult(payload) {
  if (!isObject(payload)) {
...
export function assertFavoritesToggleResult(payload) {
  if (!isObject(payload)) {
...
export function assertDownloadQueueStatus(payload) {
  if (!isObject(payload)) {
...
export function formatEventLine(eventPayload) {
